      ...
      <section className="w-full max-w-3xl mx-auto p-8 rounded-3xl shadow-2xl bg-white/80 dark:bg-gray-950/90 backdrop-blur-lg border border-gray-200 dark:border-gray-800">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex gap-6 mt-6">
            <a href="mailto:your@email.com" className="text-gray-500 hover:text-blue-500 transition" aria-label="Email">
            ...
            <a href="https://github.com/yourusername" target="_blank" rel="noopener" className="text-gray-500 hover:text-blue-500 transition" aria-label="GitHub">
            ...
            <a href="https://linkedin.com/in/yourusername" target="_blank" rel="noopener" className="text-gray-500 hover:text-blue-500 transition" aria-label="LinkedIn">
